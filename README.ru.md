...
const localizer = new Localizer({
  locale: 'fr',         // текущая локаль (опционально)
...
Для обработки форм множественного числа используется объект со специальными
ключами, список которых зависит от выбранной локали.
...
console.log(localizer.t('iHaveApples', 100)); // > 100 
```
